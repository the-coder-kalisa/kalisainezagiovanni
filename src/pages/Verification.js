...
<div className={`flex flex-col items-center`}>
          ...
          <div className="text-center py-5 text-xl text-gray-700">We've sent a 6&minus;digit code to <span className='font-[650]'>hello again</span>. The coder expires shortly,<br />so please enter it soon.</div>
